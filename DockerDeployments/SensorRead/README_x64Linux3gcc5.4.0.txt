...
data type TemperatureSensor from TemperatureSensor.idl.
This example builds two applications, named TemperatureSensorPublisher
and TemperatureSensorSubscriber.
...
command shell, type:
> make -f makefile_TemperatureSensor_x64Linux3gcc5.4.0

To Modify the Data:
===================
To modify the data being sent, in the default package (or module you specified),
open/double-click and edit the TemperatureSensorPublisher.java file
where it says:
...
-------------
Type 
> ant TemperatureSensorPublisher
or
> ant TemperatureSensorSubscriber
 
Run with Eclipse:
-----------------
Select Run > Run and choose either the TemperatureSensorPublisher or TemperatureSensorSubscriber
application.
...
Make sure that java and javac are in your path before you start. From your
command shell, type:
> make -f makefile_TemperatureSensor_x64Linux3gcc5.4.0 TemperatureSensorPublisher
> make -f makefile_TemperatureSensor_x64Linux3gcc5.4.0 TemperatureSensorSubscriber
