...
public class TemperatureSensorTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "TemperatureSensor";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final TemperatureSensorTypeSupport _singleton
    = new TemperatureSensorTypeSupport();
    ...
    */
    public static TemperatureSensorTypeSupport get_instance() {
        return _singleton;
    }

    public static TemperatureSensorTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return TemperatureSensorTypeCode.VALUE;
    }

    @Override
    public Object create_data() {
        return TemperatureSensor.create();
    }
    ...
    * <code>this</code> is not a <code>TemperatureSensor</code>
    * type.
    */
    @Override 
    public Object copy_data(Object destination, Object source) {

        TemperatureSensor typedDst = (TemperatureSensor) destination;
        TemperatureSensor typedSrc = (TemperatureSensor) source;
        ...
        Object sample) 
    {
        ...
        short encapsulation_id = CdrEncapsulation.getEncapsulationFromFinal(
            ...
            ExtensibilityKind.EXTENSIBLE_EXTENSIBILITY);
        boolean xcdr1 = (encapsulation_id <= CdrEncapsulation.CDR_ENCAPSULATION_ID_PL_CDR_LE);
        TemperatureSensor typedSrc = (TemperatureSensor) sample;
        ...
        currentAlignment  +=  _cdrPrimitiveType.getStringSerializedSize(epd.getAlignment(currentAlignment), typedSrc.sensorID );

        currentAlignment  +=  _cdrPrimitiveType.getStringSerializedSize(epd.getAlignment(currentAlignment), typedSrc.location );

        currentAlignment  +=  _cdrPrimitiveType.getStringSerializedSize(epd.getAlignment(currentAlignment), typedSrc.unit );

        currentAlignment  +=  _cdrPrimitiveType.getDoubleMaxSizeSerialized(epd.getAlignment(currentAlignment));

        currentAlignment  +=  _cdrPrimitiveType.getStringSerializedSize(epd.getAlignment(currentAlignment), typedSrc.readtime );
    ...
    short final_encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeString(typedSrc.sensorID,255);
            dst.writeString(typedSrc.location,255);
            dst.writeString(typedSrc.unit,255);
            dst.writeDouble(typedSrc.value);
            dst.writeString(typedSrc.readtime,255);
            if(!xcdr1){            
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            TemperatureSensor typedDst = (TemperatureSensor) dst;
            typedDst.clear();      
            int DHtmpPosition = 0;
            int DHtmpSize = 0;
            long DHtmpLength = 0;
            ...
            try{
                typedDst.sensorID = src.readString(255);
                typedDst.location = src.readString(255);
                typedDst.unit = src.readString(255);
                typedDst.value = src.readDouble();
                typedDst.readtime = src.readString(255);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            TemperatureSensor typedDst = (TemperatureSensor) sample;
            deserialize_sample(
    ...
    int mask) {
        return new TemperatureSensorDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new TemperatureSensorDataReader(native_reader, listener, mask, this);   
    ...
    protected TemperatureSensorTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false, TemperatureSensorTypeCode.VALUE, TemperatureSensor.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected TemperatureSensorTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport, TemperatureSensorTypeCode.VALUE, TemperatureSensor.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
